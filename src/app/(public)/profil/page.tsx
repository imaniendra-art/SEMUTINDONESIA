            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 border border-gray-100 dark:border-gray-800">
                {settings.profil_sejarah ? (
                  <div dangerouslySetInnerHTML={{ __html: settings.profil_sejarah.replace(/&nbsp;/g, ' ') }} className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 w-full overflow-hidden [&_p]:!mb-1 [&_p]:!mt-0 [&_h1]:!mb-2 [&_h2]:!mb-2 [&_h3]:!mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:!mb-1 [&_*]:!text-left [&_*]:!break-normal" />
                ) : (
            ...
            <section>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-8 border border-gray-100 dark:border-gray-800">
                {settings.profil_visi_misi ? (
                  <div className="prose dark:prose-invert max-w-none w-full overflow-hidden [&_p]:!mb-1 [&_p]:!mt-0 [&_h1]:!mb-2 [&_h2]:!mb-2 [&_h3]:!mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:!mb-1 [&_*]:!text-left [&_*]:!break-normal" dangerouslySetInnerHTML={{ __html: settings.profil_visi_misi.replace(/&nbsp;/g, ' ') }} />
                ) : (
